...
if(isset($_POST['registration']) && $_POST['registration'] == "submit")
{
	...
	{
		header("Location: http://localhost/project/Final_project/admin/login_user.php");
	}
	else
	{
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Product_Attribute</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted">Attribute <code>Data</code></p>
