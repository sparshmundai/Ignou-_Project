...
$sql_query = "select * from `product` where `status` = 1 and `category`= ".$cat_id." AND `brand`=".$brand;
$products = array();
$att_result = $conn->query($sql_query);
if($att_result->num_rows > 0)
{
...
<?php
include("default/sub_navbar.php")
?>
